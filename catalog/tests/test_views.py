...
class AuthorListViewTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        for author_num in range(number_of_authors):
            Author.objects.create(first_name=f'Cristian {author_num}', last_name=f'Surname {author_num}',)

    def test_view_url_exists_at_desired_location(self):
        resp = self.client.get('/catalog/authors/')
        self.assertEqual(resp.status_code, 200)

    def test_view_url_accesible_name(self):
...
class LoanedBookInstancesByUserListViewTest(TestCase):
    ...
    def setUp(self):
        ...
        test_book = Book.objects.create(title='Book Title', summary = 'My book summary', 
                                        isbn='ASDFGH', author=test_author)
        ...
        for book_copy in range(number_of_book_copies):
            ...
            status = 'm'
            BookInstance.objects.create(book=test_book, imprint='Unlike Imprint, 2016', due_back=return_date, 
...
class RenewBookInstancesViewTest(TestCase):
    ...
    def setUp(self):
        ...
        test_author = Author.objects.create(first_name='Jonh', last_name='Smith')
        test_genre = Genre.objects.create(name='Fantasy')
        test_book = Book.objects.create(title='Book Title', summary='My book summary', isbn='ADERFTG', 
                                        author=test_author)
        genre_objects_for_book = Genre.objects.all()
        test_book.genre.set(genre_objects_for_book)
        test_book.save()
    ...
    def test_form_invalid_rebewal_date_past(self):
        login = self.client.login(username='testuser2', password='12345')
